import AsmFunctionsWrapper from './GuitarStringAsm.js';
import getControlsValues,{calculateSmoothingFactor} from './getControlsValues.js';

export default function GuitarString(audioCtx, audioDestination, stringN, octave, semitone) {
    ...
    this.acousticLocation = (((5 - stringN) % 5) - 2.5) * 0.4;
